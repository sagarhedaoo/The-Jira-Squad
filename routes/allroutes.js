...
router.get('/account', async (req, res) => 
{
	...
	try
	{
		...
		res.render('useraccount', {username: loggedUser.username, nickname: loggedUser.nickname, 'post-list':posts, loggedUser});
	}
	catch(e)
	{
...
router.post('/signin', async (req, res) => 
{
    ...
    res.status(401).render('signin', {message: "Error : Credentials do not match. No Account? Register now!"}); 
});
...
{ 
	...
	try 
	{
		...
		res.render('useraccount',{username: updatedUser.username, nickname: updatedUser.nickname, 'post-list':posts, success1:success1, success2:success2, success3:success3, loggedUser: updatedUser}); 
	} 
	catch (e) 
	{ 
		let message1;
		...
		res.status(404).render('useraccount',{username: ous, nickname: odn, 'post-list':posts, message1:message1, message2:message2, message3:message3, message4:message4, loggedUser: oldUser}); 
	}
});
